param(
    ...
    [int] $NLstmLayers = 1,
    [string] $RunName = "ppo_lstm_multiinput_semantic_spatial_memory_binary_v6_forever",
    [string] $ModelPath = "models\ppo_lstm\junimo_ppo_lstm_multiinput_binary_v6_forever",
    [string] $LoadModel = "",
    [int] $EpisodeOffset = -1,
    [switch] $NoAutoResume
)
...
Write-Host "PPO-LSTM MultiInput v6 continuous training"
