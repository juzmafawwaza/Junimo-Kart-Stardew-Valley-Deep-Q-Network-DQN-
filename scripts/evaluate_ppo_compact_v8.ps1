param(
    [string]$Models = ".\logs\ppo\ppo_compact_shaped_v5_binary_5k\checkpoints\junimo_ppo_ep*.zip",
    [int]$Episodes = 100,
    [string]$Out = "logs\ppo\ppo_compact_shaped_v5_binary_5k\evaluation_100ep.csv",
    [switch]$Stochastic
)
