param(
    ...
    [string]$ModelPath = "models\ppo\junimo_ppo_compact_shaped_v6_3k",
    [string]$LogDir = "logs\ppo",
    [string]$RunName = "ppo_compact_shaped_v6_from_1500_to_3k",
...
Write-Host "Continuing PPO checkpoint episode $EpisodeOffset with compact observations, binary control, and shaped_v6."
& python @arguments
exit $LASTEXITCODE
