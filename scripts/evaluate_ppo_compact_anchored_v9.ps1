param(
    [string[]]$Models = @(
        ...
        ".\logs\ppo\ppo_compact_anchored_v9_from_1500_to_3k\checkpoints\junimo_ppo_ep*.zip"
    ),
    [int]$Episodes = 20,
    [string]$Out = "logs\ppo\ppo_compact_anchored_v9_from_1500_to_3k\evaluation_deterministic_20ep.csv",
